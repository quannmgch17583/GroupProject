    ...
    <div class="container-fluid">
        <div class="wrapper">
            ...
            <header id="headersidebar"></header>
                <ul class="nav-bar">
                    <li><a href="guest-panel.php"><i class="fas fa-tachometer-alt"></i>&nbsp; Dashboard</a></li>
            ...
            <div class="modal fade" id="settings" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="p-3" style="margin-top: 50px;">
                        <?php include 'php/guest-view.php'; 
                            if (mysqli_num_rows($res) > 0 ) { ?>
                        <h1 class="display-4 fs-1 text-center">All Accepted <?=$_SESSION['department']?> Submissions</h1>
